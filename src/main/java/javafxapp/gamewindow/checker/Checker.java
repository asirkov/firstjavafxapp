...
//
////        // Create inner circle
////        Ellipse inbg = new Ellipse(CheckerConfig.CHECKER_X_RADIUS * TILE_SIZE * 0.75,
////                                  CheckerConfig.CHECKER_Y_RADIUS * TILE_SIZE * 0.75);
...
////        inbg.setStrokeWidth(TILE_SIZE * CheckerConfig.CHECKER_STROKE_WIDTH);
////
////        inbg.setTranslateX((TILE_SIZE - TILE_SIZE * CheckerConfig.CHECKER_X_RADIUS * 2) / 2);
////        inbg.setTranslateY((TILE_SIZE - TILE_SIZE * CheckerConfig.CHECKER_Y_RADIUS * 2) / 2);
//
//        // Creating front size
