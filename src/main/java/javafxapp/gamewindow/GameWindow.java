...
public class GameWindow extends Application {
    public static int TILE_SIZE = (int) (Config.WINDOW_HEIGHT / 10);
    ...
    private Pane createGamePane(double width) {
        Pane root = new Pane();
        TILE_SIZE = (int)width / WIDTH;
...
//            }
    ...
    private BorderPane createGameWindowPane(PlayerModel participant1, PlayerModel participant2, double width, double height) {
        BorderPane bp = new BorderPane();
        bp.setMinSize(width, height);

        Pane gamePane = createGamePane(width * 0.5d);

        bp.setLeft(new PlayerMaxInfoView(participant1, width * 0.25d));
        bp.setRight(new PlayerMaxInfoView(participant2, width * 0.25d));
...
//        bp.setBackground(new Background(new BackgroundFill(Color.GRAY, CornerRadii.EMPTY, Insets.EMPTY)));
    ...
    public void start(Stage primaryStage) throws Exception {
        PlayerModel p1 = new PlayerModel(1L, 1L, "Developer", 9999L, 0.99d, true);
        PlayerModel p2 = new PlayerModel(1L, 1L, "Jora", 129L, 0.64d, false);

        BorderPane mainWindowPane = createGameWindowPane(p1, p2, Config.WINDOW_WIDTH, Config.WINDOW_HEIGHT);

        Scene scene = new Scene(mainWindowPane, Config.WINDOW_WIDTH, Config.WINDOW_HEIGHT);
